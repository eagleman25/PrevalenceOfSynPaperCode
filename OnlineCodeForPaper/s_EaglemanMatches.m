...
% makes three structs
% rgb has the rgb values for each subject and letter for the empirical and
% several comparison distributions
%
% labels has the color labels for each subject and letter for the empirical
% and comparison distributions
% 
% nummatches has the number of matches between the various distribution and
% the magnet set as well as the most modal matching behavior
...
% shuffle by column (this is shuffling used in paper)
...
% shuffle by row (shuffle each subject's data)
...
s(3,:) = hist(nummatches.random, 0:26);
s(4,:) = hist(nummatches.uniform, 0:26);
